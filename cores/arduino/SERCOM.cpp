...
void SERCOM::initSPI(SercomSpiTXPad mosi, SercomRXPad miso, SercomSpiCharSize charSize, SercomDataOrder dataOrder)
{
  ...
  //Setting the CTRLA register
  sercom->SPI.CTRLA.reg =	SERCOM_SPI_CTRLA_MODE(0x2) |
...
void SERCOM::initClockNVIC( void )
{
  ...
  if(this->sercom == SERCOM0)
  {
    clockId = GCM_SERCOM0_CORE;
    IdNvic = SERCOM0_IRQn;
	MCLK->APBCMASK.bit.SERCOM0_ = 1;
  }
  else if(this->sercom == SERCOM1)
  {
    clockId = GCM_SERCOM1_CORE;
    IdNvic = SERCOM1_IRQn;
	MCLK->APBCMASK.bit.SERCOM1_ = 1;
  }
  else if(this->sercom == SERCOM2)
  {
    clockId = GCM_SERCOM2_CORE;
    IdNvic = SERCOM2_IRQn;
	MCLK->APBCMASK.bit.SERCOM2_ = 1;
  }
  else if(this->sercom == SERCOM3)
  {
  ...
  //Setting clock
  GCLK->PCHCTRL[clockId].reg = GCLK_PCHCTRL_GEN_GCLK0 | // Generic Clock Generator 0 is source
                      GCLK_PCHCTRL_CHEN ;
